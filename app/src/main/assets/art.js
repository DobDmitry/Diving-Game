...
const POSES={
 ...
 /* 4 класс: короткий упругий подсед «как на скакалке», руки остаются сверху.
    Глубина взята с видео 109C (кадр 27): колено сгибается примерно на 52°,
    таз идёт следом, корпус чуть наклоняется вперёд. Замаха вниз нет, руки
    не опускаются ни на сантиметр. Стопа остаётся на носках, как в стойке.
    1 класс идёт с разбега и подседает иначе — ему служит hopRun. */
 ...
 /* Приход с наскока на две ноги у самого края: колени принимают вес.
    Руки к этому мигу уже прошли вертикаль и уходят назад — начало маха. */
 landFw:   {torso:8, spine:2, head:-3,sh:-20,el:-4, hip:16, knee:34, ank:78},
 /* Подсед после наскока — только 1 класс. Ноги те же, что в hopFw, а руки
    работают: на видео 109C (кадры 32–36) они прямыми уходят за голову
    градусов на сорок и оттуда махом идут вверх, приходя в «стрелочку»
    ровно к отрыву. Локоть при этом почти не сгибается — это мах, не складка.
    Прежний разбор обрывался на кадре 30 и мах не застал. */
 hopRun:   {torso:10,spine:2, head:-3,sh:-44,el:-8, hip:26, knee:52, ank:84},
 ...
 /* раскрытие из складки, 1 и 4 класс: уголок, ноги прямые, руки разведены в стороны.
 ...
 /* рука прямая и вынесена вперёд почти горизонтально: при складке 55° она
    ложится в клин между грудью и бедром и не пересекает линию ноги */
 openFw:   {torso:5, spine:-2,head:10,sh:100,el:0,  hip:125,knee:0,  ank:0, armF:0.85, armFar:0},
 /* Раскрытие из группировки, 1 и 4 класс (107C, 109C, 407C). Уголок им не годится:
    на видео 109C (кадры 77–82) спортсмен не показывает угол, а простреливает
    из шара сразу в длину — колени выстреливают первыми, таз доворачивает следом,
    руки сходят с голеней и тянутся к воде. Держать после этого нечего, поэтому
    таз всего 48°, а руки почти дошли до «стрелочки» — вход её только дочистит. */
 openTuck: {torso:3, spine:-2,head:8, sh:38, el:0,  hip:48, knee:0,  ank:0},
...
/* Уход в группировку: руки ведут, складка идёт следом. На видео (107B, кадры
   42–46) спортсмен сначала вытянутым тянется руками к ногам и только потом
   складывается — раньше здесь первым шёл таз, и захват выглядел как рывок.
   Порядок важен и по существу: пока тело прямое, вращение ещё медленное. */
